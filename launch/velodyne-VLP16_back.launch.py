...
def generate_launch_description():
    ...
    convert_params_file = os.path.join(concert_config_dir, 'config','VLP16_back-velodyne_convert_node-params.yaml')
    ...
    driver_params_file = os.path.join(concert_config_dir, 'config', 'VLP16_back-velodyne_driver_node-params.yaml')
